# 13 — Execute committed Shop budgets and late-Shop value

**What to build:** Buy an exact committed key and eligible late rank-5 bag in safe order, while giving Shop route value only when current authoritative inventory and Gold justify it.
